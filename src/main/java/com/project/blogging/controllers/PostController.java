...
public class PostController {
	...
	public ResponseEntity<PostDto> createPost(@RequestBody PostDto postDto, @PathVariable Integer userId,
		...
		PostDto postTo = this.postService.createPost(postDto, userId, categoryId);

		return new ResponseEntity<>(postTo, HttpStatus.CREATED);
	...
	public ResponseEntity<PostResponse> getAllPosts(
			...
			@RequestParam(value="sortedByDir", defaultValue=AppConstants.SORT_BY_DIR, required=false ) String sortedByDir ) {
		PostResponse postResponse = this.postService.getAllPosts(pageNumber, pageSize, sortedBy, sortedByDir);
